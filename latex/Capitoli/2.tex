...
Nelle sezioni precedenti, come indicato in precedenza, per effettuare una fase esplorativa e calibrare i parametri dell'algoritmo, si è proceduto a prendere in considerazione solo i primi 1000 record del dataset.

Per convalidare i risultati si è dunque applicato l'algrotimo all'intero dataset, scoprendo uno dei limiti principali dell'algoritmo di isolation forest. Degli attacchi inseriti manualmente solo uno viene riconosciuto come tale. dei circa 4 milioni di record, circa 100.000 vengono riconosciuti come anomalie e gli attacchi inseriti manualmente vengono classificati come Falsi Negativi.
...
Appare quindi evidente che il rumore di fondo generato dai web crawler offuschi quelli che l'algoritmo dovrebbe catalogare come attacchi.